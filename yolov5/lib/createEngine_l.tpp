...
ICudaEngine *createEngine_l(unsigned int maxBatchSize, IBuilder *builder, IBuilderConfig *config, DataType dt) {
    ...
    auto bottleneck_csp20 = bottleneckCSP(network, weightMap, *cat19->getOutput(0), 512, 512, 3, false, 1, 0.5,
                                          "model.20");
    //yolo layer 1
    ...
    auto bottleneck_csp23 = bottleneckCSP(network, weightMap, *cat22->getOutput(0), 1024, 1024, 3, false, 1, 0.5,
                                          "model.23");
